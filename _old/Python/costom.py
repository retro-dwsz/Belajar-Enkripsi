...
def main():
    # Contoh penggunaan
    mapping_length = 99  # Bisa diubah ke 100 untuk map 100 karakter
    char_map = generate_char_map(mapping_length)

    encryptor = CustomEncryptor()

    text = "Ää Ââ Àà \" Hello, World! 123"
    print("Original Text: ", text)

    # Enkripsi
    encrypted_text = encryptor.encrypt(text, char_map)
    print("Encrypted Text: ", encrypted_text)

    # Dekripsi
    decrypted_text = encryptor.decrypt(encrypted_text, char_map)
